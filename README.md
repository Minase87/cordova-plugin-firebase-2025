...
This plugin depends on `cordova-plugin-androidx` and `cordova-plugin-androidx-adapter` to handle AndroidX compatibility. Ensure your project is configured for AndroidX.
